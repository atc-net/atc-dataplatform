...
class ConcatDfTest(unittest.TestCase):
    ...
    def test_concat_one_df(self):
        ...
        self.assertEqual(
            1, get_number_rows_1(result, "1", "Fender", "Telecaster", year="1950")
        )
        self.assertEqual(
            1, get_number_rows_1(result, "2", "Gibson", "Les Paul", year="1959")
        )
    ...
    def test_concat_two_df(self):
        ...
        self.assertEqual(
            1, get_number_rows_2(result, "1", "Fender", "Telecaster", year="1950")
        )
        self.assertEqual(
            1, get_number_rows_2(result, "2", "Gibson", "Les Paul", year="1959")
        )
        self.assertEqual(1, get_number_rows_2(result, "3", "Ibanez", "RG", year="1987"))
        self.assertEqual(
            1, get_number_rows_2(result, "1", "Fender", "Stratocaster", size="Small")
        )
        self.assertEqual(
            1,
            get_number_rows_2(result, "2", "Gibson", "Les Paul Junior", size="Medium"),
        )
        self.assertEqual(
            1, get_number_rows_2(result, "3", "Ibanez", "JPM", size="Large")
        )
    ...
    def test_concat_three_df(self):
        ...
        self.assertEqual(
            1, get_number_rows_3(result, "1", "Fender", "Telecaster", year="1950")
        )
        self.assertEqual(
            1, get_number_rows_3(result, "2", "Gibson", "Les Paul", year="1959")
        )
        self.assertEqual(1, get_number_rows_3(result, "3", "Ibanez", "RG", year="1987"))
        self.assertEqual(
            1, get_number_rows_3(result, "1", "Fender", "Stratocaster", size="Small")
        )
        self.assertEqual(
            1,
            get_number_rows_3(result, "2", "Gibson", "Les Paul Junior", size="Medium"),
        )
        self.assertEqual(
            1, get_number_rows_3(result, "3", "Ibanez", "JPM", size="Large")
        )
        self.assertEqual(
            1, get_number_rows_3(result, "1", "Fender", "Jaguar", color="Brown")
        )
        self.assertEqual(
            1, get_number_rows_3(result, "2", "Gibson", "EB", color="Blue")
        )
        self.assertEqual(
            1, get_number_rows_3(result, "3", "Ibanez", "AE", color="Black")
        )
